...
{
    public class TaxCalculatorDefinitionService : ITaxCalculatorDefinitionService
    {
        public TaxDefinition GetTaxDefinition(DateTime moment)
        {
            //This is prove of concept. Hard-coded data.
            return GetTestTaxDefinition(moment);
            //TODO: Realize later the business logics
            throw new NotImplementedException("Service is not realized");
        }

        public TaxDefinition GetTestTaxDefinition(DateTime moment)
        {
            //This is prove of concept. Hard-coded data.
