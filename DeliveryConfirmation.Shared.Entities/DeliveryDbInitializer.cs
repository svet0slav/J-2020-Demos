...
namespace DeliveryConfirmation.Shared.Entities
{
    public class DeliveryDbInitializer : System.Data.Entity.DropCreateDatabaseIfModelChanges<DeliveryDbContext>
    {
        protected override void Seed(DeliveryDbContext context)
        {
            ...
            {
            new Trucks{ TruckModel="BMW", TruckNumber="BM12345YA" },
            new Trucks{ TruckModel="ASC", TruckNumber="AS12345YA" },
            new Trucks{ TruckModel="Toyota", TruckNumber="To12345YA" },
            new Trucks{ TruckModel="Nissan", TruckNumber="Ni12345YA" },
            new Trucks{ TruckModel="Renault", TruckNumber="Re12345YA" },
            new Trucks{ TruckModel="Volvo", TruckNumber="VO12345YA" },
            };
            ...
            {
                new Shipments{ OriginName = "Ben Johnson", OriginAddress = "508 Rue de la, Gauchetière E, Montréal, QC H2L 4W4, Canada",
                ...
                new Shipments{ OriginName = "Ben Verhan", OriginAddress = "508 Rue de la, Gauchetière E, Montréal, QC H2L 4W4, Canada",
                ...
                new Shipments{ OriginName = "Yorg Johnson", OriginAddress = "508 Rue de la, Gauchetière E, Montréal, QC H2L 4W4, Canada",
                    DestinationName = "Chris Rea", DestinationAddress = "1242 Rue de la Visitation, Montréal, QC H2L 3B4, Canada",
                    Delivered = false, Status = ShipmentStatuses.OutForDelivery, Truck = trucks[random.Next(0,trucks.Count-1)] },
                new Shipments{ OriginName = "Ronald Bears", OriginAddress = "508 Rue de la, Gauchetière E, Montréal, QC H2L 4W4, Canada",
                ...
                new Shipments{ OriginName = "Guy Richy", OriginAddress = "102 Rue Selkirk, Hudson, QC J0P 1H0, Canada",
            ...
            for (int i = 0; i < 99; i++)
            {
                ...
                shipments.ForEach(s => shipments.Add(new Shipments()
                {
